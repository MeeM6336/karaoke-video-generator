...
def upload_video_to_youtube(youtube, video_file, title, artist, song, thumbnail_path, tags=None):
  description = f"""
...
def main():
  ...
  parser.add_argument(
    "--thumbnail",
    type="str",
    help="Path to thumbnail or None for autogenerated"
  )
  ...
  upload_video_to_youtube(youtube, video_file, title, artist, song, tags, thumbnail_path, thumbnail_path)
